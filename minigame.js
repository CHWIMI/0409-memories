...
(function () {
    ...
    function spawnObstacle() {
        ...
        // 속도에 비례하여 최소/최대 간격을 동적으로 보장 (고속에서도 점프/착지 시간 확보)
        const speedFactor = Math.max(1, speed / INITIAL_SPEED);
        const dynamicMinGap = OBSTACLE_MIN_GAP * speedFactor;
        const dynamicMaxGap = OBSTACLE_MAX_GAP * speedFactor;
        nextObstacleDistance = dynamicMinGap + Math.random() * dynamicMaxGap;
    }
